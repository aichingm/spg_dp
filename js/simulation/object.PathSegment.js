function PathSegment(pxPerMeter) {
    ...
    this.prepare = function () {
        ...
        this.maxRunners = this.distance / pxPerMeter * 2 * 2;

    };
    this.workload = function () {
        //console.log(this.currentRunners , this.maxRunners)
        return (this.currentRunners / this.maxRunners) * 100;
    };
